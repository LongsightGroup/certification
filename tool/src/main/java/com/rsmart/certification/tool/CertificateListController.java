...
public class CertificateListController extends BaseCertificateController
{
		...
		HttpServletResponse response) throws Exception
	{
    	...
    	if(page==null && export==null && pageSize==null)
		{
	    	...
	    	/* Set<String> userIds = getHistoricalGradedUserIds(); - historical is disabled by default
     ...
     * @param certId the certificate we are reporting on
     ...
     */
    public List<ReportRow> getReportRows(CertificateDefinition definition, String filterType, String filterDateType, Date startDate, Date endDate, List<String> userIds, HttpSession session)
    {
